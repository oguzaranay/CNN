...
#    train_labels, train_features, _ = mlc_datasets.get_APDM()
    train_labels, train_features, _ = mlc_datasets.get_data('train')
#    train_labels, train_features, _ = mlc_datasets.generateGraph('train') # incomplete
    
    num_epochs=150
    net = value_nets.ValueNetwork('./graph_dvn_inf_gt',
...
#    test_labels, test_features, _, __ = mlc_datasets.get_bibtex('test')
    test_labels, test_features, _, __ = mlc_datasets.get_data('test')

    # Evaluate the final model
    # mlc_datasets.evaluate_f1(net.predict, test_features, test_labels)
    mlc_datasets.evaluate_IOU(net.predict, test_features, test_labels)
